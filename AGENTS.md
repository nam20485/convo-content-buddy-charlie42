...
<instructions>
  ...
  <template_usage>
    <summary>
      This repository is a **GitHub template repo** (`nam20485/convo-content-buddy-charlie42`).
    ...
    <creation_workflow>
      ...
      <step>2. That delegates to `./scripts/create-repo-with-plan-docs.ps1` which:
        - Creates a new GitHub repo from this template via `gh repo create --template nam20485/convo-content-buddy-charlie42`
        ...
        - Replaces all template placeholders (`convo-content-buddy-charlie42` → new repo name, `nam20485` → new owner)
    ...
    <template_design_constraints>
      <rule>Template placeholders (`convo-content-buddy-charlie42`, `nam20485`) in file contents and paths are replaced by the creation script. Keep them consistent.</rule>
